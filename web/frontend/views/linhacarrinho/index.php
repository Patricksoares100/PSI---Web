                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            ...
                            <td class="align-middle"><?= $model->artigo->preco?> €</td> <!-- vai buscar ao modelo o getArtigo - MASTER DETAIL-->
                            <td class="align-middle"><?= $model->artigo->iva->percentagem?> %</td>
                            <td class="align-middle"><?= number_format(($model->artigo->iva->percentagem * $model->artigo->preco)/100,2)?> €</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    ...
                                    <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" value="<?= $model->quantidade ?>">
                                    <div class="input-group-btn">
                            ...
                            <td class="align-middle"><?=number_format($model->quantidade * ($model->artigo->preco + (($model->artigo->iva->percentagem * $model->artigo->preco)/100)),2)?> €</td>
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <a href="<?= \yii\helpers\Url::to(['/site/checkout']) ?>" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Proceed To Checkout</a>
                    </div>
                </div>
            </div>
        </div>
