...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 09-Jan-2024 às 18:41
...
--
-- Banco de dados: `bdbrindeszorro_test`
--
...
(1, 'Caneta Aluminio', 'Caneta Preta Potente', 'CAN001', 2.5, 47, 1, 1, 1, 1);
...
(2, '2023-12-29 12:43:03', 6.15, 'Emitida', 3);
...
INSERT INTO `favoritos` (`id`, `artigo_id`, `perfil_id`) VALUES
(1, 1, 3);
...
(1, NULL, 1, 'uploads/canetas_20231229124002.jpg'),
(2, NULL, 2, 'uploads/favoritos_icon_20231229124028.png'),
...
--
-- Extraindo dados da tabela `linhas_carrinho`
--

INSERT INTO `linhas_carrinho` (`id`, `quantidade`, `artigo_id`, `perfil_id`) VALUES
(3, 1, 1, 3);
